(ns advent-of-code-2018.dec1)

(def frequency-changes "+3
+15
-1
-18
+3
...
(clojure.string/split-lines frequency-changes)

(def aha "(+ 1 1)")

(eval (read-string aha))

(re-matches #"abc(.*)" "abcxyz")
(re-matches #"(\+|\-)(\d*)" "-9")

(defn extract-sign-and-digit
  [frequency]
  (let [groups (rest (re-matches #"(\+|\-)(\d*)" frequency))]
    [(first groups) (last groups)]))

(extract-sign-and-digit "-100")
